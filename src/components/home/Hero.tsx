  ...
  return (
    ...
    >
      ...
      <div className={`relative z-10 text-center px-6 max-w-4xl mx-auto ${fade} ${peeking ? "pointer-events-none" : ""}`}>
        ...
        <h1 className="reveal-load font-display text-7xl md:text-9xl text-white/90 uppercase mb-6 leading-[0.9] [text-shadow:0_2px_20px_rgba(0,0,0,0.6)]" style={{ animationDelay: "0.2s" }}>
          Clean Tones
        </h1>
