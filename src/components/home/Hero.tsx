...
export default function Hero() {
  ...
  return (
    <section className="relative h-screen min-h-[600px] flex items-end sm:items-center justify-center overflow-hidden bg-neutral-900">
      {/* Background photo (art-directed) */}
      <picture>
        <source media="(min-width: 768px)" srcSet={desktopSrcSet} />
        <source media="(max-width: 767px)" srcSet={mobileSrcSet} />
        {/* eslint-disable-next-line jsx-a11y/alt-text */}
        <img {...imgProps} className="object-contain object-top sm:object-cover sm:object-center" />
      </picture>
      ...
      {/* Content */}
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto pb-14 sm:pb-0">
        ...
        <h1 className="reveal-load font-display text-6xl sm:text-7xl md:text-9xl text-white uppercase mb-5 sm:mb-6 leading-[0.9] [text-shadow:0_3px_24px_rgba(0,0,0,0.85)]" style={{ animationDelay: "0.2s" }}>
          Clean<br />Tones
        </h1>
